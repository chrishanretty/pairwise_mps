...
here::i_am("R/005_free_thresholds.R")
...
writeLines(stan_code, con = here::here("working", "freethresh.stan"))

fit <- stan(file = here::here("working", "freethresh.stan"),
            data = data_list,
            seed = 123,
            chains = 4,
            cores = 4,
...
saveRDS(fit, file = here::here("working", "freethresh_fit.rds"))
...
saveRDS(s, file = here::here("working", "freethresh_smry.rds"))
...
saveRDS(theta, file = here::here("working", "freethresh_thetas.rds"))
...
saveRDS(theta, file = here::here("working", "freethresh_theta_iters.rds"))
